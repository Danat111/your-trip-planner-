...
const ContactSection: React.FC = () => {
  ...
  return (
    <Section variant="default" spacing="xl" id="contact">
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                ...
                <a 
                  ...
                  className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-blue-700 hover:text-white transition-colors"
                  aria-label="LinkedIn"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
