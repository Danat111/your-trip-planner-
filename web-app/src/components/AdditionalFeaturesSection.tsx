...
const AdditionalFeaturesSection: React.FC = () => {
  ...
  const { ADDITIONAL_FEATURES } = getConstants(t);
  return (
    <Section variant="default" spacing="xl" id="additional-features">
      <div className="text-center mb-16">
        ...
        >
          Discover additional tools that enhance your travel experience
        </motion.p>
      </div>
            ...
            <Card className="h-full hover:shadow-md transition-shadow duration-300">
              <div className="p-6">
                <div className="w-12 h-12 rounded-lg bg-indigo-100 flex items-center justify-center mb-4">
                  <FeatureIcon id={feature.id} className="w-6 h-6 text-indigo-600" />
                </div>
